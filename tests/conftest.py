...
def session_fixture() -> dict:
    ...
    model_info = {
        ...
        "input_data": json.dumps({
            "MedInc": 1.6812, "HouseAge": 25.0, "AveRooms": 4.192200557103064,
            "AveBedrms": 1.0222841225626742, "Population": 1392.0,
            "AveOccup": 3.877437325905293, "Latitude": 36.06, "Longitude": -119.01,
            "model_name": "linear"
        })
    }
    return model_info
